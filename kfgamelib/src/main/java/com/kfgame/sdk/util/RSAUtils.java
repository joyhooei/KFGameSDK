...
public class RSAUtils {
     ...
     * @return
     */
    public static String rsaEncrypt(String encryptString , Key key) {
        byte[] ret = null;
    ...
    public static String rsaDecrypt(String encryptString, Key key) {
        byte[] ret = null;
        byte[] data = Base64.decode(encryptString.getBytes(), Base64.NO_WRAP);
        if (data != null && data.length > 0 && key != null) {
            try {
                Cipher cipher = Cipher.getInstance("RSA");
