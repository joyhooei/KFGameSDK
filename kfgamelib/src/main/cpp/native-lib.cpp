...
Java_com_kfgame_sdk_common_getEncodeKey(JNIEnv *env, jobject /* this */) {
    std::string encodekey = "abcdefg123456";
    return env->NewStringUTF(encodekey.c_str());
}

JNIEXPORT jstring JNICALL
Java_com_kfgame_sdk_common_getMd5(JNIEnv *env, jobject, jstring str) {
